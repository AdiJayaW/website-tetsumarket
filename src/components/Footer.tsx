...
return (
    ...
    {/* Footer Content */}
    <div className="max-w-7xl mx-auto px-4 pb-12 pt-4 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
        <div>
        <div className="flex items-center gap-2 mb-4">
            <div className="bg-gradient-to-r from-purple-600 to-cyan-500 p-1.5 rounded-lg">
            <ShieldCheck className="w-5 h-5 text-white" />
            </div>
            <span className="font-bold text-lg text-white">Trust<span className="text-cyan-400">Market</span></span>
        </div>
        ...
        <ul className="space-y-2 text-xs text-slate-400">
            <li><a href="#" className="hover:text-white">Buy Accounts</a></li>
            <li><a href="#" className="hover:text-white">Sell Account</a></li>
